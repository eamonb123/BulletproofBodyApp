...
interface SnackBrand {
  id: string;
  name: string;
  category: "chips" | "candy" | "cookies" | "icecream" | "baked" | "cereal" | "drinks" | "snacks" | "spreads" | "meat";
}

// Top 35 homepage items sorted by calorie gap (DB homepage_rank)
const SNACK_BRANDS: SnackBrand[] = [
  // Ice Cream (780-120 cal gaps)
  ...
  { id: "orville", name: "Orville Redenbacher's", category: "chips" },
  // Candy & Chocolate
  ...
  { id: "cocoapuffs", name: "Cocoa Puffs", category: "cereal" },
  // Drinks
  { id: "cocacola", name: "Coca-Cola", category: "drinks" },
  // Snacks & Other
  { id: "snackpack", name: "Snack Pack", category: "snacks" },
  { id: "nutella", name: "Nutella", category: "spreads" },
  { id: "slimjim", name: "Slim Jim", category: "meat" },
  { id: "almonds", name: "Almonds", category: "snacks" },
  { id: "trailmix", name: "Trail Mix", category: "snacks" },
];

// Logo file extensions — all 35 homepage items
...
const BRAND_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  cocoapuffs: { bg: "#3D1F00", text: "#FFD700" },
  cocacola: { bg: "#D52B1E", text: "#FFFFFF" },
  snackpack: { bg: "#003DA5", text: "#FFFFFF" },
  nutella: { bg: "#3D1F00", text: "#FFFFFF" },
  slimjim: { bg: "#D52B1E", text: "#FFD700" },
  almonds: { bg: "#006B3F", text: "#FFFFFF" },
  trailmix: { bg: "#8B4513", text: "#FFFFFF" },
};
